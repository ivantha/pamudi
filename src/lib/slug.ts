 ...
 * The product name is already the entry's identity in both consumers, so the
 * URL is derived from it rather than written down beside it.
 *
 * A consequence worth knowing before renaming a product: the URL changes with
 * it. That is the right trade for a site with fourteen of these and no
